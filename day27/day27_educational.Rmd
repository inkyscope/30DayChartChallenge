...
plot <- df_plastic %>% 
  ...
  labs(title = "Plastic Types by Comapnies With Most Collected in 2019-2020",
       subtitle = "Top 6 companies are selected along with plsastic types collected by volunteers around world<br>in the **Break Free from Plastic** events in 2019-2020",
...
ggsave(plot = plot,
       filename = file.path("../day27", "day27_educational.png"),
       dpi = 300, width = 40, height = 25, units = "cm")
```
