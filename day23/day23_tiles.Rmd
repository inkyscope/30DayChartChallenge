...
```{r}
etherium <- readr::read_csv("C:/Users/inkyscope/Documents/projectR/30DayChartChallenge/day23/etherium_historical_data.csv") %>% 
  clean_names()
```
...
ggsave(here::here("day23", "day23_tiles.png"), dpi = 300, width = 20, height = 14, units = "cm")
