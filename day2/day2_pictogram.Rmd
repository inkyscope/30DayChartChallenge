...
plot <- df %>% 
  ...
  labs(title = "Plastic Types by Comapnies With Most Collected in 2019-2020",
       subtitle = "Illustrated below that amount of plastics along with top 20 companies collected by voluteers around world<br>in the **Break Free from Plastic** events in 2019-2020",
...
ggsave(here::here("day2", "day2_pictogram.png"),
       dpi = 300, width = 31, height = 24, units = "cm")
